...
export default function Footer() {
  return (
    <footer className="bg-[#0E0B08] border-t border-line pt-20 pb-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-14 mb-14">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="flex gap-3 mt-6">
              ...
              >
                <svg className="w-4 h-4 text-cream-dim group-hover:text-bg fill-current transition-colors" viewBox="0 0 24 24">
              ...
              <a
                ...
                className="w-9 h-9 border border-line rounded-full flex items-center justify-center hover:border-gold hover:bg-gold group transition-all duration-300"
              >
                <svg className="w-4 h-4 text-cream-dim group-hover:text-bg transition-colors" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">
