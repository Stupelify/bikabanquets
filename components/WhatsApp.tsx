  ...
  return (
    <div className="fixed bottom-7 right-7 z-40">
      <a
        ...
        className="relative w-14 h-14 bg-[#25D366] rounded-full flex items-center justify-center shadow-lg hover:scale-110 transition-transform duration-300 block"
      >
        <span className="animate-wa-pulse absolute inset-0 rounded-full border-2 border-[#25D366]" />
